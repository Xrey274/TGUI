...
TEST_CASE("[ClickableWidget]")
{
    ...
    SECTION("Signals")
    {
        ...
        REQUIRE_NOTHROW(widget->connect("MousePressed", [](tgui::Widget::Ptr, std::string, tgui::Vector2f){}));
        ...
        REQUIRE_NOTHROW(widget->connect("MouseReleased", [](tgui::Widget::Ptr, std::string, tgui::Vector2f){}));
        ...
        REQUIRE_NOTHROW(widget->connect("Clicked", [](tgui::Widget::Ptr, std::string, tgui::Vector2f){}));
        ...
        REQUIRE_NOTHROW(widget->connect("RightMousePressed", [](tgui::Widget::Ptr, std::string, tgui::Vector2f){}));
        ...
        REQUIRE_NOTHROW(widget->connect("RightMouseReleased", [](tgui::Widget::Ptr, std::string, tgui::Vector2f){}));
        ...
        REQUIRE_NOTHROW(widget->connect("RightClicked", [](tgui::Widget::Ptr, std::string, tgui::Vector2f){}));
    }
