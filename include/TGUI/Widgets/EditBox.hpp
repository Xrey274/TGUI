...
namespace tgui
{
    ...
    public:
        ...
        /// @endcode
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        bool setInputValidator(const String& regex = ".*");
    ...
    protected:
        ...
        std::u32string m_displayedText; // Same as m_text unless a password char is set

        String m_regexString = ".*";
        std::regex m_regex = std::regex{m_regexString.toAnsiString()};
