...
namespace tgui
{
    ...
    public:
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        TGUI_CONSTEXPR Vector2() = default;
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    template <typename T>
    TGUI_CONSTEXPR Vector2<T>& operator+=(Vector2<T>& left, const sf::Vector2<T>& right)
    {
        left.x += right.x;
        left.y += right.y;
        return left;
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    template <typename T>
    TGUI_CONSTEXPR Vector2<T> operator+(const Vector2<T>& left, const sf::Vector2<T>& right)
    {
        return {left.x + right.x, left.y + right.y};
    }
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    template <typename T>
    TGUI_CONSTEXPR bool operator==(const Vector2<T>& left, const sf::Vector2<T>& right)
    {
        return (left.x == right.x) && (left.y == right.y);
    }
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    template <typename T>
    TGUI_CONSTEXPR Vector2<T>& operator+=(sf::Vector2<T>& left, const Vector2<T>& right)
    {
        left.x += right.x;
        left.y += right.y;
        return left;
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    template <typename T>
    TGUI_CONSTEXPR Vector2<T> operator+(const sf::Vector2<T>& left, const Vector2<T>& right)
    {
        return {left.x + right.x, left.y + right.y};
    }
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    template <typename T>
    TGUI_CONSTEXPR bool operator==(const sf::Vector2<T>& left, const Vector2<T>& right)
    {
        return (left.x == right.x) && (left.y == right.y);
    }
